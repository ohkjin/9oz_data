...
class ResNet_VAE(nn.Module):
    def __init__(self, resnet_model, fc_hidden1=1024, fc_hidden2=768, drop_p=0.3, CNN_embed_dim=256):
        ...
        if self.resnet_model==34:
          resnet = models.resnet34(pretrained=True)
        if self.resnet_model==50:
          resnet = models.resnet50(pretrained=True)
        if self.resnet_model==101:
          resnet = models.resnet101(pretrained=True)
        if self.resnet_model==152:
          resnet = models.resnet152(pretrained=True)
